...
//                if (teamMember != null) {
//                    MemberStudy memberStudy = createMemberStudy(teamMember, studyInfo, MEMBER);
...
//                        .member(member)
//                        .studyInfo(studyInfo)
//                        .role(MemberRoleStatus.MEMBER) // 기본 역할 설정
//                        .build();
//                memberStudyRepository.save(memberStudy);
//                memberStudies.add(memberStudy);
...
//        return memberStudyRepository.findByMemberIdAndStudyIdAndRole(memberId, studyId, MEMBER)
//                .orElseThrow(() -> new EntityNotFoundException("MemberStudy entry not found"));
//    }
//
